...
--------------------------------|-----------------|---------------|-------------------------|------------------------------|-----------------------------------------------------------
    ...
    substituto_st               |   -            |  Não          |  Texto                   |  1 caractere                 |  Trata-se de um atributo específico para uso do engine de cálculo TaxRules da TaxWeb. <strong>Valores válidos: S ou N</strong>
