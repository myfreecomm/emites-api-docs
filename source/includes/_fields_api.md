...
--------------------------------|-----------------|---------------|-------------------------|------------------------------|-----------------------------------------------------------
    engine_de_calculo           | -               |   Não         |     Texto               |              -               |    Campo interno do Emites para indicar a engine de cálculo a ser utilizada caso habilitada.<br>Ex:<br><strong>"taxweb"</strong>: Exclusivamente para casos onde o taxengine será o TaxRules <br><strong>"nexaas"</strong>: Exclusivamente para casos onde o taxengine será o Template Tributário Nexaas <br>Observação: Nos casos onde a request já está calculada, este atributo <strong>não</strong> deve ser enviado na request.
