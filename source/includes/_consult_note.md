...
A resposta conterá os mesmos campos que foram enviados na requisição, e adicionalmente campos exclusivos especificos sobre o status da NF-e:
...
A resposta conterá os mesmos campos que foram enviados na requisição, e adicionalmente campos exclusivos especificos sobre o status de rejeição da NF-e:
...
A resposta conterá os mesmos campos que foram enviados na requisição, e adicionalmente campos exclusivos especificos sobre o status de rejeição causada por erro de validação de Schema da NF-e:
...
A resposta conterá os mesmos campos que foram enviados na requisição, e adicionalmente campos exclusivos especificos sobre o status da NFC-e:
...
A resposta conterá os mesmos campos que foram enviados na requisição, e adicionalmente campos exclusivos especificos sobre o status de rejeição da NFC-e:
...
A resposta conterá os mesmos campos que foram enviados na requisição, e adicionalmente campos exclusivos especificos sobre o status de rejeição causada por erro de validação de Schema da NFC-e:
